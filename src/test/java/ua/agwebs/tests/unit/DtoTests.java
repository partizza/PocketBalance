...
import ua.agwebs.web.rest.accounting.AccountingTransactionDTO;
...
public class DtoTests {
    ...
    @Test
    public void test_ModelMapper_AccountingTransactionDTO() {
        AppUser appUser = new AppUser("bf@u.com", "An", "Xe");
        appUser.setId(999L);
        ...
        AccountingTransactionDTO transactionDTO = mapper.map(transaction, AccountingTransactionDTO.class);
